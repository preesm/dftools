 ...
 * <ul>
 * <li>{@link net.sf.dftools.architecture.slam.attributes.VLNV#getVendor <em>
 * Vendor</em>}</li>
 * <li>{@link net.sf.dftools.architecture.slam.attributes.VLNV#getLibrary <em>
 * Library</em>}</li>
 * <li>{@link net.sf.dftools.architecture.slam.attributes.VLNV#getName <em>Name
 * </em>}</li>
 * <li>{@link net.sf.dftools.architecture.slam.attributes.VLNV#getVersion <em>
 * Version</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface VLNV extends EObject {
	...
	/**
	 * Sets the value of the '
	 * {@link net.sf.dftools.architecture.slam.attributes.VLNV#getName
