 ...
 * <ul>
 * <li>{@link net.sf.dftools.architecture.slam.component.Dma#getSetupTime <em>
 * Setup Time</em>}</li>
 * </ul>
 * </p>
 * 
 * @see net.sf.dftools.architecture.slam.component.ComponentPackage#getDma()
 * @model
 * @generated
 */
public interface Dma extends Enabler {
	 ...
	 * @see net.sf.dftools.architecture.slam.component.ComponentPackage#getDma_SetupTime()
	 * @model default="0"
	 * @generated
	 */
	int getSetupTime();
	 ...
	 * {@link net.sf.dftools.architecture.slam.component.Dma#getSetupTime
