 ...
 * <ul>
 *   <li>{@link net.sf.dftools.util.impl.WrapperXmlImpl#getXml <em>Xml</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WrapperXmlImpl extends EObjectImpl implements WrapperXml {
	...
	protected EClass eStaticClass() {
		return UtilPackage.Literals.WRAPPER_XML;
	}
	...
	public void setXml(String newXml) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UtilPackage.WRAPPER_XML__XML, oldXml, xml));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UtilPackage.WRAPPER_XML__XML:
			return getXml();
		}
