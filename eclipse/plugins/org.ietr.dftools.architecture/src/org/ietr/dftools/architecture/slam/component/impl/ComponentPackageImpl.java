...
public class ComponentPackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDma_SetupTime(), ecorePackage.getEInt(), "setupTime", "0", 0, 1, Dma.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(memEClass, Mem.class, "Mem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMem_Size(), ecorePackage.getEInt(), "size", "1", 1, 1, Mem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
