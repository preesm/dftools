package net.sf.dftools.algorithm.model.listenable;
...
public class DAGListenableGraph extends DirectedAcyclicGraph implements
	ListenableGraph<DAGVertex, DAGEdge> {
		...
		public DAGEdge addEdge(DAGVertex sourceVertex,
				DAGVertex targetVertex) {
		 ...
		 */
		public boolean addEdge(DAGVertex sourceVertex,
				DAGVertex targetVertex, DAGEdge e) {
		 ...
		 */
		/*
		public DAGEdge addEdgeWithLink(DAGVertex sourceVertex,
				DAGVertex targetVertex) {
			DAGEdge e = super.addEdgeWithLink(sourceVertex, targetVertex);
...
//*/
		...
		private GraphVertexChangeEvent<DAGVertex> createGraphVertexChangeEvent(
			...
			if (reuseEvents) {
				...
				return new GraphVertexChangeEvent<DAGVertex>(this,
						eventType, vertex);
			}
		}
		 ...
		 */
		public DAGEdge removeEdge(DAGVertex sourceVertex,
				DAGVertex targetVertex) {
