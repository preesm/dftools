...
public class ComponentAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.ietr.dftools.architecture.slam.component.ComNode
	 ...
	 * <em>Hierarchy Port</em>}'. <!-- begin-user-doc --> This default
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.ietr.dftools.architecture.slam.component.ComInterface
	 * <em>Com Interface</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>VLN Ved Element</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
