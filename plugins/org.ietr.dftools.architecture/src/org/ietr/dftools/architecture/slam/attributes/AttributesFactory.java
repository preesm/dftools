...
public interface AttributesFactory extends EFactory {
	 ...
	 * @generated
	 */
	AttributesFactory eINSTANCE = org.ietr.dftools.architecture.slam.attributes.impl.AttributesFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>VLNV</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
